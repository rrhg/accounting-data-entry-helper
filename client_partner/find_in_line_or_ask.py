...
def find_in_line_or_ask(line,
    ...
    partner_key = find_strings_in_line(line, previous_line, partners_dict, infered_payee_in_ck_image=infered_payee_in_ck_image)
    if partner_key:
        return partner_key
...
def find_vendor_in_line_or_ask(line, previous_line, infered_payee_in_ck_image="", msg_if_not_found=''):
    return find_in_line_or_ask(line, previous_line, ptype=vendor,infered_payee_in_ck_image=infered_payee_in_ck_image, msg_if_not_found=msg_if_not_found )
