...
from utils.other import ask_to_continue, close_photos_windows_app, activate_powershell
    ...
    for ck_line in checks_lines:
        ...
        if ( client.use_only_the_1st_ck_when_duplicated() and ck_number in ck_nums_found):
            ...
            if hasattr(client, 'vendor_key_when_client_enters_checks_info'):
                vendor_dict['vendor_key'] = client.vendor_key_when_client_enters_checks_info()
            ...
            # New check ! Need to get data, so show ck image if we have it
                ...
                vendor_dict = get_or_create_vendor_dict_from_ck_line(ck_line,ck_number,client_have_cks_imgs )
            ...
            new_transactions = get_debit_transaction_from_check_line(vendor_dict['vendor_key'], ck_line,previous_line )
